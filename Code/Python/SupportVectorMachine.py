# SupportVectorMachine.py: This code implements Regression SVM to analyse Training Data Set and build a
...
plt.title('SVR Testing Error')
plt.xlabel('Percentage Error')
plt.ylabel('Number of instances')
plt.grid(True)
plt.show()
plt.plot(testOutput, testPredicted, 'bo', tempplot, tempplot, 'r-')
plt.title('SVR: Testing Result - Actual vs Predicted')
plt.xlabel('Actual')
